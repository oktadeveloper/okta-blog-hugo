...
<img src="/img/blog/java-token-auth/create-new-app.png" alt="Create Okta App" width="700" class="center-image">
...
<img src="/img/blog/java-token-auth/client-credentials.png" alt="App with Client Credentials" width="600" class="center-image">

Click **Done**.

Take note of the **Client ID** and **Client Secret** at the bottom of the following page. You'll need these later.

<img src="/img/blog/java-token-auth/client-id-secret.png" alt="Client ID and Client Secret" width="700" class="center-image">
...
<img src="/img/blog/java-token-auth/add-scope.png" alt="Add Custom Scope" width="700" class="center-image">
