...
<img src="/img/blog/go-vue/vue-cli.gif" alt="Use the vue-cli to initialize a program" width="600" class="center-image">
...
<img src="/img/blog/go-vue/vue-default-page.png" alt="Vue default page" width="600" class="center-image">
...
<img src="/img/blog/go-vue/add-vueify.gif" alt="Add vueify" width="600" class="center-image">
...
<img src="/img/blog/go-vue/vuetify-page.png" alt="Vuetify page" width="600" class="center-image">
...
<img src="/img/blog/go-vue/okta-sign-up.png" alt="Okta sign-up page" width="600" class="center-image">

Once logged in, create a new application by clicking "Add Application".

<img src="/img/blog/go-vue/okta-add-application.png" alt="Okta add application" width="600" class="center-image">

Select the "Single-Page App" platform option.

<img src="/img/blog/go-vue/okta-create-app.png" alt="Okta create application" width="600" class="center-image">

The default application settings should be the same as those pictured.

<img src="/img/blog/go-vue/okta-app-settings.png" alt="Okta application settings" width="600" class="center-image">
...
<img src="/img/blog/go-vue/vue-landing-page.png" alt="Vue landing page" width="600" class="center-image">

With our login component rendered, the user will be redirected to the login page after clicking the sign in button.

<img src="/img/blog/go-vue/okta-sign-in.png" alt="Okta sign-in" width="600" class="center-image">
...
<img src="/img/blog/go-vue/vue-app.png" alt="Vue app" width="600" class="center-image">
